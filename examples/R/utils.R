...
#' Constructs an nominal MDP and a confidence interval
#'
...
mdp.frequentist <- function(simulation, rewards.df){
  ...
  return (list(mdp.nominal = mdp.nominal,  sa_counts = sa_counts))
}
...
## Baysian posterior
baysian.posterior <- function(simulation, rewards.truth, bayes.samples){
