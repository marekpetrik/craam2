...
GRBModel::get(GRB_IntParam param) const
{
  ...
  int error = GRBgetintparam(Cenv, iparname[param], &value);
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
...
GRBModel::get(GRB_DoubleParam param) const
{
  ...
  int error = GRBgetdblparam(Cenv, dparname[param], &value);
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
...
GRBModel::get(GRB_StringParam param) const
{
  ...
  int error = GRBgetstrparam(Cenv, sparname[param], value);
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
...
{
  int error = GRBsetintparam(Cenv, iparname[param], value);
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
}
...
{
  int error = GRBsetdblparam(Cenv, dparname[param], value);
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
}
...
{
  int error = GRBsetstrparam(Cenv, sparname[param], (char*) value.c_str());
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
}
...
{
  int error = GRBsetparam(Cenv, param.c_str(), value.c_str());
  if (error) throw GRBException(string(GRBgeterrormsg(Cenv)), error);
}
