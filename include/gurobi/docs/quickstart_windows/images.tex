...
\argument{#1}{The \texttt{#1} argument that was passed into the user
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1701}%
\scalebox{1.0}{\includegraphics[width=3in]{logo.png}}%
\lthtmlpictureZ
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1922}%
...
%
\providecommand{\grbgetkey}{you'll need to run the {\ttfamily grbgetkey}
  command on your machine to retrieve your Gurobi license key. Note
  that the machine must be connected to the Internet in order to run
  this command. An Internet connection is not required after you have
  obtained your license key.}%


%
\providecommand{\nonetwork}{If your computer isn't connected to the
  Internet or if your network security system does not allow the
  command below to function, we also offer a manual license key
  process.  You'll find manual instructions at the bottom of the
  License Detail page (by following the link labeled {\em click here
    for additional instructions\/}).}%


%
\providecommand{\defaultloc}{(either your home directory or {\ttfamily
    \GRBplatform{/opt/}{/Library/}{c:\textbackslash}gurobi})}%

\stepcounter{section}
\stepcounter{section}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1990}%
\scalebox{1.0}{\includegraphics[width=6.5in]{graphics/license}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap2102}%
\scalebox{1.0}{\includegraphics[width=4in]{graphics/startrun}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\scalebox{1.0}{\includegraphics[width=6.2in]{graphics/anaconda_linux}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7188}%
\scalebox{1.0}{\includegraphics[width=6.2in]{graphics/anaconda_mac}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7262}%
\scalebox{1.0}{\includegraphics[width=6.5in]{graphics/spyder_linux1}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7276}%
\scalebox{1.0}{\includegraphics[width=5.5in]{graphics/spyder_linux2}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7286}%
\scalebox{1.0}{\includegraphics[width=5.5in]{graphics/spyder_linux3}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\scalebox{1.0}{\includegraphics[width=6.5in]{graphics/jupyter_linux1}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7353}%
\scalebox{1.0}{\includegraphics[width=4in]{graphics/runwindow}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap7371}%
\scalebox{1.0}{\includegraphics[width=6in]{refman_misc/codedraw8.png}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
