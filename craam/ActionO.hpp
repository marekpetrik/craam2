...
*/
class ActionO : public internal::OutcomeManagement {
protected:
...
public:
    ...
    /**
     * Sets the base distribution over the outcomes. The function checks for
    ...
    /**
     * Sets the weight for a particular outcome.
     * The function *does not* check for the correctness of
     * the distribution.
     *
     * @param distribution New distribution of outcomes.
